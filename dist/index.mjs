...
var webFetch_20250910ArgsSchema = z4.object({
  /**
   ...
   */
  maxContentTokens: z4.number().optional()
});
var webFetch_20250910OutputSchema = z4.object({
  url: z4.string(),
  documentType: z4.string(),
  contentSource: z4.string(),
...
var codeExecution_20250522OutputSchema = z5.object({
  type: z5.literal("code_execution_result"),
  stdout: z5.string(),
  stderr: z5.string(),
  return_code: z5.number()
});
var factory3 = createProviderDefinedToolFactoryWithOutputSchema3({
...
// src/anthropic-messages-language-model.ts
var citationSchemas = {
  webSearchResult: z6.object({
    type: z6.literal("web_search_result_location"),
    cited_text: z6.string(),
    url: z6.string(),
    title: z6.string(),
    encrypted_index: z6.string()
  }),
  pageLocation: z6.object({
    type: z6.literal("page_location"),
    cited_text: z6.string(),
    document_index: z6.number(),
    document_title: z6.string().nullable(),
    start_page_number: z6.number(),
    end_page_number: z6.number()
  }),
  charLocation: z6.object({
    type: z6.literal("char_location"),
    cited_text: z6.string(),
    document_index: z6.number(),
    document_title: z6.string().nullable(),
    start_char_index: z6.number(),
    end_char_index: z6.number()
  })
};
var citationSchema = z6.discriminatedUnion("type", [
  citationSchemas.webSearchResult,
  citationSchemas.pageLocation,
  citationSchemas.charLocation
]);
var documentCitationSchema = z6.discriminatedUnion("type", [
  citationSchemas.pageLocation,
  citationSchemas.charLocation
]);
...
var anthropicMessagesResponseSchema = z6.object({
  ...
  content: z6.array(
    z6.discriminatedUnion("type", [
      z6.object({
        ...
        text: z6.string(),
        citations: z6.array(citationSchema).optional()
      }),
      z6.object({
      ...
      z6.object({
        type: z6.literal("server_tool_use"),
        id: z6.string(),
        name: z6.string(),
        input: z6.record(z6.string(), z6.unknown()).nullish()
      }),
      z6.object({
        type: z6.literal("web_search_tool_result"),
        ...
        content: z6.union([
          z6.array(
            z6.object({
              ...
              url: z6.string(),
              title: z6.string(),
              encrypted_content: z6.string(),
              page_age: z6.string().nullish()
            })
          ),
          z6.object({
            type: z6.literal("web_search_tool_result_error"),
            error_code: z6.string()
          })
        ])
      }),
      z6.object({
        type: z6.literal("code_execution_tool_result"),
        tool_use_id: z6.string(),
        content: z6.union([
          z6.object({
          ...
          z6.object({
            type: z6.literal("code_execution_tool_result_error"),
            error_code: z6.string()
          })
        ])
      })
  ...
  stop_reason: z6.string().nullish(),
  usage: z6.looseObject({
    input_tokens: z6.number(),
    output_tokens: z6.number(),
    cache_creation_input_tokens: z6.number().nullish(),
    cache_read_input_tokens: z6.number().nullish()
  })
});
var anthropicMessagesChunkSchema = z6.discriminatedUnion("type", [
  z6.object({
  ...
  z6.object({
    ...
    delta: z6.discriminatedUnion("type", [
      ...
      z6.object({
        type: z6.literal("signature_delta"),
        signature: z6.string()
      }),
      z6.object({
        type: z6.literal("citations_delta"),
        citation: citationSchema
      })
    ])
  }),
  z6.object({
    type: z6.literal("content_block_stop"),
    index: z6.number()
  }),
  z6.object({
  ...
  z6.object({
    ...
    delta: z6.object({ stop_reason: z6.string().nullish() }),
    usage: z6.object({ output_tokens: z6.number() })
  }),
  z6.object({
    type: z6.literal("message_stop")
  }),
  z6.object({
    type: z6.literal("ping")
  })
]);
var anthropicReasoningMetadataSchema = z6.object({
  signature: z6.string().optional(),
  redactedData: z6.string().optional()
});
...
var computer_20241022 = createProviderDefinedToolFactory3({
  ...
  inputSchema: z9.object({
    ...
    coordinate: z9.array(z9.number().int()).optional(),
...
var computer_20250124 = createProviderDefinedToolFactory4({
  ...
  inputSchema: z10.object({
    ...
    coordinate: z10.tuple([z10.number().int(), z10.number().int()]).optional(),
    duration: z10.number().optional(),
    scroll_amount: z10.number().optional(),
    scroll_direction: z10.enum(["up", "down", "left", "right"]).optional(),
    start_coordinate: z10.tuple([z10.number().int(), z10.number().int()]).optional(),
...
var textEditor_20250429 = createProviderDefinedToolFactory7({
  ...
  inputSchema: z13.object({
    command: z13.enum(["view", "create", "str_replace", "insert"]),
    path: z13.string(),
